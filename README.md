...
| [docs/2026-09-17-knowledge-graph-tools.md](docs/2026-09-17-knowledge-graph-tools.md) | 知识图谱工具选型与实战记录（CodeGraph×graphify 双图谱分工） |
...
| 版本 | 日期 | 变更 |
|------|------|------|
| **v2.4** | 2026-09-19 | 新增知识图谱工具选型与实战记录（docs/）；4.8 表补安装列；新增 4.9 全量装机清单（含安装来源）；4.5 补 mattpocock-skills |
| v2.3 | 2026-09-17 | 六环节工作流增强：环节 3 外科手术式改动条款；新增 4.8 资产与工具路由（六工具+双图谱分工）；排障约定三条；环节 2 开源选型核验（默认用成熟开源，自写需论证） |
